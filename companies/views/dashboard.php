            ...
            <div class="stepper-premium animate-fade-in delay-1">
                ...
                <div class="step-box">
                    <div class="step-content">
                        ...
                        <p>En producción, la empresa descarga y completa la plantilla institucional.</p>
                    </div>
                    <span class="btn-premium secondary" title="Documento privado excluido de la demo" style="flex-shrink:0; padding: 10px 18px; font-size: .875rem; opacity:.7; cursor:not-allowed;">
                        <i class="fas fa-lock"></i> No incluido en la demo
                    </span>
                </div>
