...
<body>
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <p class="nav-section-label" style="margin-top: 15px;">Trámites</p>
            <a href="tramites_ss.php" class="nav-link <?php echo ($current_page == 'tramites_ss') ? 'active' : ''; ?>">
                <span class="nav-icon"><i class="fas fa-file-contract"></i></span> Servicio Social
            </a>
        </nav>
